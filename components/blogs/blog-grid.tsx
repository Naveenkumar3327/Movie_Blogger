...
const blogs = [
  ...
  {
    id: '4',
    title: 'The Art of Film Noir: Shadows and Light in Classic Cinema',
    excerpt: 'Diving deep into the visual language and storytelling techniques that define the film noir genre.',
    author: 'David Park',
    authorInitials: 'DP',
    date: '2024-01-08',
    readTime: '8 min read',
  ...
  {
    id: '5',
    title: 'International Cinema: Hidden Gems from Around the World',
    excerpt: 'Discovering exceptional films from various countries that deserve global recognition and appreciation.',
    author: 'Lisa Kim',
    authorInitials: 'LK',
    date: '2024-01-05',
    readTime: '6 min read',
  ...
  {
    id: '6',
    title: 'The Future of Streaming: How Platforms are Changing Movies',
    excerpt: 'Examining the impact of streaming services on film production, distribution, and viewer habits.',
